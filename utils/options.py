...
def options():
    ...
    parser.add_argument("--momentum", type=float, default=0.90, help="SGD with Momentum: value of the momentum")
    ...
    parser.add_argument("--n_sample", type=int, default=100, help="number of dataset of evaluation")
